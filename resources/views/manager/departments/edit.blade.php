      ...
      <div class="col-lg-12 grid-margin stretch-card">
              <div class="card" style="border-bottom: 5px solid #82A448; margin: 0px;">
                <div class="card-body">
                  ...
                  <form method="POST" action="{{ url(app()->getLocale().'/manager/departments/'.$department->id) }}">
                        @csrf
                        @method('put')

                        <div class="form-group row">
                            <label for="name" class="col-md-2 col-form-label text-md-right">Deaprtment name</label>

                            <div class="col-md-8">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name')!=null ? old('name') : $department->name }}" >
