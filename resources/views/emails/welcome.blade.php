            ...
            <table cellspacing="0">
              <tr>
                <td>
                  <table class="soapbox">
                    <tr>
                      <td class="soapbox-title">Welcome to  {{$details['company']}} </td>
                    </tr>
                  </table>
                  ...
                  <table class="body">
                    <tr>
                      ...
                      <td class="body-padded">
                        <div class="body-title">Hey {{$details['name']}},</div>
                        <table class="body-text">
                          <tr>
                            <td class="body-text-cell">
                              Your {{$details['userType']}} profile has been generated. <br/>

                              Please use credentials below to login
                              ...
                              Click here to login now : {{$details['link']}}
                            </td>
                          </tr>
                        </table>
                        ...
                        <![endif]--><a href="{{$details['link']}}"
                        style="background-color:#41CC00;background-image:url(https://www.filepicker.io/api/file/N8GiNGsmT6mK6ORk00S7);border:1px solid #407429;border-radius:4px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:17px;font-weight:bold;text-shadow: -1px -1px #47A54B;line-height:38px;text-align:center;text-decoration:none;width:190px;-webkit-text-size-adjust:none;mso-hide:all;">Click here to login!</a></div>
                        <table class="body-signature-block">
                          <tr>
                            <td class="body-signature-cell">
                              <p>Thanks</p>
                              <p class="body-signature"><img src="https://www.filepicker.io/api/file/2R9HpqboTPaB4NyF35xt" alt="{{$details['link']}}"></p>
                            </td>
                          </tr>
                        </table>
                      </td>
