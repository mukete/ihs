  ...
  <div class="container-scroller">
    ...
    -moz-box-shadow: none; box-shadow: none;" >
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center" style="background: #10425E; width: 300px; border: solid 2px #10425E;">
        ...
        <a class="navbar-brand brand-logo mr-5" href="{{url('root/start')}}"><img src="{{url('content/logos/'.auth()->user()->company->logo)}}" class="mr-2" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="{{url('root/start')}}"><img src="{{url('content/logos/'.auth()->user()->company->logo)}}" alt="logo"/></a>
        @else
        <a class="navbar-brand brand-logo mr-5" href="{{url('root/start')}}"><img src="{{url('ihs.png')}}" class="mr-2" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="{{url('root/start')}}"><img src="{{url('ihs.png')}}" alt="logo"/></a>
        @endif
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{url('root/companies')}}">
              <span class="material-icons-outlined">dashboard</span>&nbsp;&nbsp;&nbsp;
              <span class="menu-title">Companies</span>
            </a>
          </li>
          
          <li class="nav-item {!! Request::is(app()->getLocale().'/root/departments/*') ? 'active' : '' !!}">
            <a class="nav-link" href="{{url('root/departments')}}">
              <span class="material-icons-outlined">apartment</span>&nbsp;&nbsp;&nbsp;
              <span class="menu-title">Departments</span>
            </a>
          </li>

          <li class="nav-item {!! Request::is(app()->getLocale().'/root/categories/*') ? 'active' : '' !!}">
            <a class="nav-link" href="{{url('root/categories')}}">
              <span class="material-icons-outlined">category</span>&nbsp;&nbsp;&nbsp;
              <span class="menu-title">Categories</span>
            </a>
          </li>

          <li class="nav-item {!! Request::is(app()->getLocale().'/root/courses/*') ? 'active' : '' !!}">
            <a class="nav-link" href="{{url('root/courses')}}">
              <span class="material-icons-outlined">play_lesson</span>&nbsp;&nbsp;&nbsp;
              <span class="menu-title">Courses</span>
            </a>
          </li>

          <li class="nav-item {!! Request::is(app()->getLocale().'/root/questions/*') ? 'active' : '' !!}">
            <a class="nav-link" href="{{url('root/questions')}}">
              <span class="material-icons-outlined">quiz</span>&nbsp;&nbsp;&nbsp;
              <span class="menu-title">Questions</span>
            </a>
          </li>

          <li class="nav-item {!! Request::is(app()->getLocale().'/root/users/*') ? 'active' : '' !!}">
            <a class="nav-link" href="{{url('root/users')}}">
