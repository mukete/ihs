      ...
      <div class="col-lg-12 grid-margin stretch-card">
              <div class="card" style="border-bottom: 5px solid #82A448; margin: 0px;">
                <div class="card-body">
                  ...
                  <form method="POST" action="{{ url(app()->getLocale().'/root/settings') }}" enctype="multipart/form-data" >
                        @csrf
                        ...
                        <div class="form-group row">
                            <label for="css" class="col-md-2 col-form-label text-md-right">Custom CSS</label>

                            <div class="col-md-8">

                                <textarea class="form-control @error('css') is-invalid @enderror" name="css" rows="10"></textarea>
