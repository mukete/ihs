      ...
      <div class="col-lg-12 grid-margin stretch-card">
              <div class="card" style="border-bottom: 5px solid #82A448; margin: 0px;">
                <div class="card-body">
                  ...
                  <form method="POST" action="{{ url(app()->getLocale().'/root/courses') }}" enctype="multipart/form-data" >
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        <label for="duration" class="col-md-8 offset-md-4 col-form-label text-md-right-">Duration of quiz</label>

                                        <div class="col-md-8 offset-md-4 ">
                                            <input id="duration" type="text" class="form-control @error('duration') is-invalid @enderror" name="duration" value="{{ old('duration') }}" >
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label for="random" class="col-md-8  col-form-label text-md-right-">Random number of questions</label>

                                        <div class="col-md-8  ">
                                            <input id="random" type="number" class="form-control @error('random') is-invalid @enderror" name="random" value="{{ old('random') }}" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="percentage" type="text" class="form-control @error('percentage') is-invalid @enderror" name="percentage" value="{{ old('percentage') }}" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="videos" type="file" class="form-control @error('videos') is-invalid @enderror" name="videos" value="{{ old('videos') }}" multiple="" >
