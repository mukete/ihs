      ...
      <div class="col-lg-12 grid-margin stretch-card">
              <div class="card" style="border-bottom: 5px solid #82A448; margin: 0px;">
                <div class="card-body">
                  ...
                  <form method="POST" action="{{ url(app()->getLocale().'/root/courses/'.$course->id) }}" enctype="multipart/form-data" >
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input id="videos" type="file" class="form-control @error('name') is-invalid @enderror" name="videos" value="{{ old('videos') }}" multiple="" >
