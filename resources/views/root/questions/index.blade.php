  ...
  <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form method="POST" action="{{ url(app()->getLocale().'/root/questions') }}" enctype="multipart/form-data">
                        @csrf
              ...
              <div class="card" style="border-bottom: 5px solid #82A448; margin: 0px;">
                <div class="card-body">
                  ...
                  <form action="" method="get">
                    <div class="col-md-12">
                        <select id="category" class="form-control @error('course') is-invalid @enderror" name="course" onchange="submit()" >
                          ...
                          <td>
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                ...
                                <br/>
                                <a class="dropdown-item "  href="{{ url(app()->getLocale().'/root/questions/'.$question->id) }}" onclick="event.preventDefault();
                                                     document.getElementById('delete-form-{{$question->id}}').submit();">
                                  <span class="material-icons">delete_outline</span>
                                </a>
                                <form id="delete-form-{{$question->id}}" action="{{ url(app()->getLocale().'/root/questions/'.$question->id) }}" method="post" style="display: none;">
                                    @csrf
                                    @method('delete')
                                </form>
                              </div>
